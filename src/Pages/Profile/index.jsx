...
function ProfilePage() {
  ...
  const [userInfo, setUserInformation] = useState({
    ...
    languages: ["English"],
    about:
      "Passionate explorer seeking fellow adventurers! Whether you're into spontaneous weekend getaways or planning epic international journeys, I'm here to connect and share unforgettable experiences. Let's explore the world together, one destination at a time!",
  });
